...
// tasks
// tasklarin her birinde try catch den isdifade edeceksiz.
...
// function sonuQilebiten () {
//     try{
//         for(let person of users){
//             if(person.firstName.endsWith('q')){
//                 console.log(person.firstName);

//             }else{
//                 throw new Error("Q ile biten ad yoxdur");
...
// function usersage (){
//     try{
//         let user = users.filter((item)=>item.age >100);
//         if(user.length == 0){
...
// }
// usersage ()
// 3) ele bir function yaradinki parametr olaraq id verildiyin id e gore istifadecini
// tapsin isdifadeci yoxdursa errorda id ve tapilmadigi haqda melumat yazilsin
// 
// function istifadeciniTap(id, users) {
//     try {
//       const user = users.find(person => person.id === id);
      
//       if (!user) {
//         throw new Error(`ID ${id} tapılmadı.`);
//       }
...
//   istifadeciniTap(25, users); // İstifadəçi tapıldı
//   istifadeciniTap(99, users); // İstifadəçi tapılmadı
...
//       if (!user.address) {
//         throw new Error("Bu ID " + id + " olan istifadəçinin ünvan məlumatı mövcud deyil.");
//       }
  
//       console.log("İstifadəçinin ünvanı: " + user.address.address);
//     } catch (error) {
//       console.error(error.message);
//     }
//   }
...
//   adressYoxla(24, users); // Ünvanı loga çıxarır
//   adressYoxla(99, users); // Ünvan məlumatı yoxdur
...
// const getperson =(id)=>{
//     try{
//         let findPerson = users.find((item)=>item.id==id);
//         if(findPerson.weight || ! findPerson.height){
//             throw new Error(" boy ve kilo melumatlari tam deyil id: "+id);
